...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=416, batch_size=16, augment=False, rect=True, image_weights=False):
        with open(path, 'r') as f:
            ...
            self.img_files = [os.path.join(constants.COMMON_PATH, img_file) for img_file in self.img_files]
        # print(f'path:{path}')
        ...
        # print(f'self.label_files:{self.label_files}')
        ...
        if self.rect:
            ...
            sp = os.path.join(constants.COMMON_PATH, sp)
