...
def train(
    ...
    init_seeds()
    weights = os.path.join(COMMON_PATH, 'weights' + os.sep)
    ...
    data_dict['train'] = os.path.join(COMMON_PATH, data_dict['train'])
    data_dict['valid'] = os.path.join(COMMON_PATH, data_dict['valid'])
    data_dict['names'] = os.path.join(COMMON_PATH, data_dict['names'])
    data_dict['backup'] = os.path.join(COMMON_PATH, data_dict['backup'])
    data_dict['eval'] = os.path.join(COMMON_PATH, data_dict['eval'])
